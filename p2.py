...
def main():
    ...
    print("+-------------------+-----------+-----------+----------+------------+------------+")
    print(f"| Huffman           | {text} | {huffman_redundancy:.4f}    | {huffman_h1:.4f}   | {huffman_h2:.4f}     | {huffman_h3:.4f}     |")
    print(f"| Shannon-Fano      | {text} | {shannon_fano_redundancy:.4f}    | {shannon_fano_h1:.4f}   | {shannon_fano_h2:.4f}     | {shannon_fano_h3:.4f}     |")
    print("+-------------------+-----------+-----------+----------+------------+------------+")
    ...
    print("+-------------------+-----------+-----------+----------+------------+------------+")
    print(
        f"| Huffman           | {text} | {huffman_redundancy:.4f}    | {huffman_h1:.4f}   | {huffman_h2:.4f}     | {huffman_h3:.4f}     |")
    print(
        f"| Shannon-Fano      | {text} | {shannon_fano_redundancy:.4f}    | {shannon_fano_h1:.4f}   | {shannon_fano_h2:.4f}     | {shannon_fano_h3:.4f}     |")
    print("+-------------------+-----------+-----------+----------+------------+------------+")
